...
/**
 * Area personale «My Cinema»: registrazione, accesso e sessione.
 *
...
const NOME_COOKIE = 'cinemax_cliente'
// Due settimane: chi compra i biglietti torna spesso, e rifare l'accesso a
// ogni visita è il modo più sicuro per farsi comprare il biglietto altrove.
