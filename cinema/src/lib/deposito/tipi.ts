 ...
 *
 * Il resto della piattaforma non sa nulla di file o di database: chiama `leggi`
 * e `scrivi` e basta. Aggiungere un supporto nuovo significa scrivere un altro
...
export type Deposito = {
  ...
  leggi(): Promise<Partial<Archivio> | null>
