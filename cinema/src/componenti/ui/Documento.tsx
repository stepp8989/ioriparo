...
export function Documento({
  ...
  return (
    <Sezione ampiezza="stretta" spaziatura="testata">
      <h1 className="font-titolo text-[1.8rem] leading-tight sm:text-[2.2rem]">{titolo}</h1>
      <p className="mt-3 text-[0.85rem] text-tenue">Ultimo aggiornamento: {aggiornamento}</p>

      <div
        className={[
          'mt-6 space-y-5 text-[0.98rem] leading-relaxed text-tenue',
